...
from utils.criterions import LabelSmoothingCrossEntropyLoss
...
def get_dataset(args):
    ...
    if args.dataset == "c10":
        ...
        args.size = 32
        args.padding = 4
        args.mean, args.std = [0.4914, 0.4822,
        ...
        args.size = 32
        args.padding = 4
        args.mean, args.std = [0.5071, 0.4867,
                               0.4408], [0.2675, 0.2565, 0.2761]
        train_transform, test_transform = get_transform(args)
        ...
        args.size = 32
        args.padding = 4
        args.mean, args.std = [0.4377, 0.4438,
                               0.4728], [0.1980, 0.2010, 0.1970]
        train_transform, test_transform = get_transform(args)
...
def get_dataloader(args):
    ...
    test_dl = torch.utils.data.DataLoader(
        test_ds, batch_size=args.eval_batch_size, num_workers=args.num_workers, pin_memory=True)
